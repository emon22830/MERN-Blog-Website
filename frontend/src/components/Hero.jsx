...
const Hero = () => {
    return (
        <div className='px-4 md:px-0'>
            <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:mt-0'>
                ...
                <div className='mx-w-2xl'>
                    ...
                    <div className='flex space-x-4'>
                        ...
                        <Link>
                            <Button className='border-white px-6 py-3 text-lg'>Learn More</Button>
                        </Link>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center'>
                    <img src={heroImg} alt="hero" className='md:h-[550px] md:w-[550px]' />
                </div>
            </div>
        </div>
    );
